...
const deleteRow = async (tableIndex,rowNumber, db, colname, objectId)=>{
  ...
  await doc.loadInfo();
  const sheet = doc.sheetsByIndex[tableIndex];
  const cells = await sheet.loadCells(`A${rowNumber}:C${rowNumber}`);
  ...
  console.log("--------------------");
  console.log(cellA._rawData.formattedValue);
  console.log("--------------------");
  console.log(cellB._rawData.formattedValue);
  console.log("--------------------");
  console.log(cellC._rawData.formattedValue);
  if (
